...
class GUI
{
	...
	static Menu callMenuBar(Str?[] values)
    {
    	return Menu
    	{
			...
			{
				text = "Help"
				MenuItem { text = "About me"; onAction.add |Event e| { Dialog.openInfo(e.window, "This project was done by Reginald Alexander Carson of EIE3, with assistance from Dr. Tom Clarke") } },
